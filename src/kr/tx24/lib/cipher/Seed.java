...
// reorder for little endian	  
	...
	/**
	 * <p>Seed방식 암호화1</p>
	 * 16바이트 키 값을 가지고 바이트 배열 값을 암호화한다.
	 * @param sbuffer byte[] 값
	 * @param szKey 16바이트 키 값
	 * @return
	 */
	...
	/**
	 * <p>Seed방식 복호화1</p>
	 * 암호화시 사용되었던 키 값을 가지고 복호화 한다.
	 * @param encryptBytes byte[] 값
	 * @param szKey 암호화 키 값
	 * @return
	 */
	...
	/**
	 * <p>입력한 byte[] 값에 패딩 값을 더한다.</p>
	 * 입력한 blockSize - (byte[] 길이 % blockSize) 길이 만큼 패딩 값을 더한다.
	 * 늘어난 패딩의 인자 값에는 0x00 값이 들어가며, 마지막 인덱스 값에는 blockSize - cnt 값이 들어간다.
	 * @{code
	 * 	byte[] source = {116, 101, 115, 116};
	 *  int blockSize = 3;
	 *  paddingResult = {116, 101, 115, 116, 0, 2};
	 * }
	 * @param source 
	 * @param blockSize 
	 * @return
